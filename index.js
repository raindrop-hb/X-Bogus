...
window['byted_acrawler'] || function(_0x2fdb61, _0x2c042f) {
    ...
    function _0x5bc542(_0x485b15) {
        ...
        _0x53dffa['fillText']('��???', -0xba1 * 0x1 + 0x10bf + -0x51c, -0x172e + 0x871 * 0x1 + 0xec9),
...
//form="device_platform=webapp&aid=6383&channel=channel_pc_web&sec_user_id=MS4wLjABAAAAMPXrsn44tq-G_vNR5aiqbTeRCnBkH1BmSz8AAgj13bU&max_cursor=1695315560703&locate_query=false&show_live_replay_strategy=1&count=15&publish_video_strategy_type=2&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1536&screen_height=864&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=108.0.5359.95&browser_online=true&engine_name=Blink&engine_version=108.0.5359.95&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=250&msToken=_5zkZn2CQOJoLo-ISfWZG_my5H7B3YSm1TqbF0NE_Dr5nfn_6z0R9H9rVPG1jY2-ueUwPDLg0IWEH9OrhdbU2ujvXx0rzcKQYjofGZXIx_G-B7zkya2X-c6XyJHK"
function getxb(form) {
    x = window.gxb(form, null)
    return x
}
//console.log(x);
